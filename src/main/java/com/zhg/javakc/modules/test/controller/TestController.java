...
public class TestController {
    ...
    public ModelAndView queryAll(TestEntity testEntity, HttpServletRequest request, HttpServletResponse response){
        ...
        Page<TestEntity> testEntityPage = testService.queryAll(testEntity, new Page<>(request, response));
        modelAndView.addObject("page",testEntityPage);
        return modelAndView;
    }
    ...
    public String create(TestEntity testEntity){
        ...
        return "redirect:/test/queryAll.do";
    }
    @RequestMapping("view")
    ...
    public String dalete(String[] ids){
